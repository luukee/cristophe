...
$uriSegments_url = explode("/", parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH)); 

if($uriSegments_url[1] == 'product-category') { ?>

<div class="title_outer title_without_animation" data-height="480"><div class="vc_row wpb_row section vc_row-fluid  vc_custom_1554115694489 grid_section" style=" text-align:left;"><div class=" section_inner clearfix"><div class="section_inner_margin clearfix"><div class="signup-shop-form wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner vc_custom_1554117947717"><div class="wpb_wrapper">
	
	
<?php echo do_shortcode('[rev_slider alias="shop"]'); ?>

<div class="wpb_text_column wpb_content_element ">
		<div class="wpb_wrapper">
			<?php echo do_shortcode('[ShopMenu]'); ?>
